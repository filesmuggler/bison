...
function placeObjects() {
    ...
    link1.position.set(-3,-3,0);
    link1.scale.set(0.5,5,0.5);
    scene.add(link1);
    ...
    link2.position.set(-1,0,0);
    link2.rotation.set(0,0,90*Math.PI/180);
    link2.scale.set(0.5,3,1);
    scene.add(link2);
    /*
...
function moveArm() {
    ...
    link2.rotateOnAxis(rot_vector.normalize(),theta1*Math.PI/180);
